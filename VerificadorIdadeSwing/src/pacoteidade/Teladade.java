 ...
 * @author spart
 */
public class Teladade extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Teladade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
